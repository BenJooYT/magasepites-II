...
## Formák
- egykarú, kétkarú (pihenős), háromkarú, húzott fokú, csiga, lebegő
- szerkezet: monolit vb (leggyakoribb új építésben), előregyártott vb,
  acél, fa (tetőtér, üzemi)

## Méretezés – EZT BEMAGOLNI
- `2m + sz = 60–64 cm` (m = fokmagasság, sz = belépő, járóvonalon)
- egy karon belül csak **azonos** fokméret!
- `m`: általános max **17 cm**
- akadálymentes lépcső: max **15 cm**, egyenes karú,
